"""
Django settings for NewHappy project.
...
SECRET_KEY = 'django-insecure-!c^^0#c10-#w*5i3(a1(9dam)p6p85(#3*2wd(d!o99jcz1s)y'
...
WSGI_APPLICATION = 'NewHappy.wsgi.application'
...
#     os.path.join(BASE_DIR, 'static/post_images'),
