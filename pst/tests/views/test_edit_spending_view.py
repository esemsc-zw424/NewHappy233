...
#         updated_spending = Spending.objects.get(id=self.spending.id)
#         self.assertEqual(updated_spending.title, self.form_data['title'])
#         self.assertEqual(updated_spending.amount, self.form_data['amount'])
#         self.assertEqual(updated_spending.descriptions, self.form_data['descriptions'])
#         self.assertEqual(updated_spending.spending_type, self.form_data['spending_type'])
#         self.assertEqual(updated_spending.spending_category.id, self.form_data['spending_category'])
#         self.assertEqual(updated_spending.date, datetime.strptime(self.form_data['date'], '%Y-%m-%d').date())
#         self.assertEqual(updated_spending.spending_owner, self.user)
