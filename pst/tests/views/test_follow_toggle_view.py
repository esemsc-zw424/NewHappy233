...
from pst.tests.helpers import reverse_with_next
...
class ShowUserTest(TestCase):
    ...
    def setUp(self):
        ...
        self.followee = User.objects.get(email="lll@example.org")
    ...
    def test_get_follow_toggle_with_invalid_id(self):
        ...
        self.assertRedirects(response, response_url, status_code=302, target_status_code=200)
        self.assertTemplateUsed(response, 'view_friends_list.html')